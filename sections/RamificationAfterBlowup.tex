...
\begin{proof}
     We focus our attention to $X_{\ndls_1} \times_k X_{\ndls_2}$ as total space.
     Like before, the $G$ torsor $\cP_1^{(\deg \ndls_1)} \times_k X_{\ndls_2} \to U^{(\deg \ndls_1)} \times_k X_{\ndls_2}$ is at most tamely 
     ramified at the generic point $\theta_1$ of $E_{\ndls_1} \times_k X_{\ndls_2}$
     Let $\tilde{U}$ be the open subscheme from \Cref{prop:blowup-product-relation} with morphisim $f_1$ and $f_2$ as in:
     \begin{equation*}
          \begin{tikzcd}
     ...
     \begin{enumerate}
          ...
          \item The generic point $\eta'$ of the exceptional divisor of the blowup $\text{Bl}_{(\ndls_1,\ndls_2)}(C^{(\deg \ndls_1)} \times_k C^{(\deg \ndls_2)})$
          is contained in the image of $f_2$ (identifying $\tilde{U}$ as an open subscheme of the blowup of the product).
          \item The morphism $f_1$ maps the point corresponding to $\eta_{X \times Y}$ to the product of generic points $\eta_X \times \eta_Y$.
     \end{enumerate}

     Notice that $\text{Bl}_{(\ndls_1,\ndls_2)}(C^{(\deg \ndls_1)} \times_k C^{(\deg \ndls_2)})$

     



%Like before $\boxP{\cP^{(\deg \ndls_1)}}{\cP^{(\deg \ndls_2)}} = p_1^{-1} \cP^{(\deg \ndls_2)} \wedge^G p_2^{-1} \cP^{(\ndls_2)}$
%\Cref{prop:blowup-product-relation}
%Let $\ndls = \ndls_1 + \ndls_2$.
\end{proof}
