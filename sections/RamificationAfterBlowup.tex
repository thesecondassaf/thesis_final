...
\begin{lemma}[\cite{takeuchi2019blow}, Lemma 4.1]\label{lemma:takeuchi_lemma}
...
\begin{cor}
    ...
    Then  $\Fbox{\deg \mdls}{d - \deg \mdls}$ is tamely ramified at the generic point $\theta$ of $E_{\mdls} \times_k C^{(d-\deg \mdls)}$
\end{cor}
\begin{proof}
