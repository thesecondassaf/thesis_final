...
The fibers of $\Phi_d$ (for $d \geq \deg \mdls +  2g - 1$) over any point are isomorphic to 
$$
\begin{cases}
...
see \Cref{prop:torsor_module_equivalence}), Theorem \Cref{thm:GCFT_reduced} can be reformulated in terms of $G$-torsors as follows:
...
To prove Theorem \Cref{thm:GCFT_torsors} we follow the work of \cite{takeuchi2019blow}, there he analyzed 
