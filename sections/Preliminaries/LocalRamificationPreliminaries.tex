...
We will use two standard stability properties of tame ramification. First,
ramification indices and residue-field extensions are unchanged by passage to
the completion; in particular, tameness can be checked after completion
\cite[Chapter~II, \S 2]{serreLF}. Second, finite tame extensions of a complete
discretely valued field are closed under taking Galois closures, finite
composita, and subextensions \cite[Chapter~IV, \S 2]{serreLF}.
