...
\subsubsection*{Functoriality and Relation to the Standard Jacobian}
...
\subsubsection*{Cohomological Properties at High Degree}
From this point forward, we fix a modulus $\mathfrak{m}$ which is everywhere strictly positive. Let $g$ denote the genus of $C$, which is a locally constant function on $S$. We restrict our attention to degrees $d$ satisfying the condition:
