...
Finally,
\begin{definition}
We say that the $G$-torsor $\cP$ has ramification bounded by the modulus $\mathfrak{m} = \sum n_i P_i$ if for every $i$, the ramification of $\cP|_{\Spec(\widehat{K}_{P_i})}$ at $P_i$ is bounded by $n_i$.    
\end{definition}
