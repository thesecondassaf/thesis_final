...
\begin{cor}\label{cor:abelian_equivilance_fundamental_torsors}
    ...
    \begin{equation}
        \mathrm{Hom}_{\mathrm{cont.}}(\pi_1^{\text{ét}}(X, x), G) \xrightarrow{\cong} \Tors(X_{\mathrm{Fl}}, G)
    \end{equation}
\end{cor}
...
\subsubsection*{Ramification of $G$-torsors in terms of Characters}
...
\begin{lemma}
    ...
    Assume $\cP_1$ and $\cP_2$ are two $G$-torsors on $U_{\text{ét}}$, Such that $\cP_1$ is tamely ramified at $(Z, \xi)$, and $\cP_2$ is unramified at $(Z, \xi)$.
    Then their contracted product $\cP_1 \wedge^G \cP_2$ is tamely ramified at $(Z, \xi)$.
\end{lemma}
\begin{proof}
    We can give two proofs.
