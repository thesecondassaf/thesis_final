...
\textbf{Case 2:} $\mdls > 0$.
In this case by (\textcolor{red}{add reference later - that the abel jacobi map here extends. - this is Preliminaries about blowup}, for $d$ large enough, the Abel-Jacobi morphism $\Phi_d : U^{(d)} \to \PicCm[d]$ 
