...
\declaretheorem[name=Corollary,   numbered=no, style=theoremstyle]{cor*}
...
\declaretheorem[name=Construction, sibling=theorem, style=definitionstyle]{construction}
